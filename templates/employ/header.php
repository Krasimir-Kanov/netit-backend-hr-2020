...
<body id="body">
  <nav class="navbar navbar-expand-lg navbar-light static-top">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php">
            <img src="./img/home.png" width="30" height="30" class="d-inline-block align-top"></a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="signup.php">Employ</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="signup-employer.php">Employer</a>
        </li>
    ...
    <?php if (Auth::isAuthenticated()) { ?>
      ...
      <!-- Търсачката по категория или по съдържание -->
      <div>
        ...
        <form method="$_GET">
          ...
          <section class="row justify-content-left">
              ...
              <div class="col">
                <input class="input pd-7" type="text" placeholder="Search Offers" name="q">
              </div>
