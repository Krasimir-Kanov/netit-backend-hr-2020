...
<body id="body">
  <nav class="navbar navbar-expand-lg navbar-light static-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto">
        <?php if (Auth::isAdmin()) { ?>
          <li class="nav-item"><a class="nav-link" href="admin_jobs.php">Jobs managment</a></li>
        <?php } ?>

        <?php if (Auth::isAdmin()) { ?>
          <li class="nav-item"><a class="nav-link" href="admin_category.php">Category managment</a></li>
        <?php } ?>
      </ul>
  ...
  <div id="content">
    <!-- ТРЯБВА ДА ПРОВЕРЯ ДАЛИ ТОВА СТАВА И ЗА USERS-->