...
if (isset($_POST['user_request_tokken']) && $_POST['user_request_tokken'] == 1) {
    ...
    if($isUserCreated) { redirectTo('signin'); }
} 
   /* Опитах се да създам функция която да връща,че регистрацията е успешна и да премества на нова страница.
    echo '<b class="register-success" >Employer created successfuly</b>';
    
    function phpAlert($msg) {
    echo "<script>alert('$message');</script>"; } 
    phpAlert("Employer created successfuly"); */